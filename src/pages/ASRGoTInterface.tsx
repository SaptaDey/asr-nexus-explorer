                  ...
                  <Button 
                    onClick={() => {
                      const debugData = {
                        ...
                        isProcessing,
                        researchContext: {
                          topic: researchContext.topic || 'UNDEFINED',
                          topicLength: researchContext.topic?.length || 0,
                          field: researchContext.field || 'UNDEFINED',
                        ...
                        graphData: {
                          ...
                          nodeTypes: graphData.nodes.reduce((acc: any, node: any) => {
                        ...
                        stage2Error: {
                          description: 'Stage 2 failed: Invalid input: must be a non-empty string',
